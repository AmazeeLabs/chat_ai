...
class ChatUISettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['chat_ui']['path_pages_exclude'] = [
      ...
      '#default_value' => $this->config('chat_ui.settings')->get('path_pages_exclude'),
    ...
    $form['appearance']['theme_mode'] = [
      ...
      '#default_value' => $this->config('chat_ui.settings')->get('theme_mode') ?: 'light',
